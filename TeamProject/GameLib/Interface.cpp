...
void	Interface::ToNDC()
{
	...
	m_VertexList[1].p = m_VertexList[0].p + TVector3(width * 2, 0, 0);
	m_VertexList[2].p = m_VertexList[0].p + TVector3(0, -height * 2, 0);
	m_VertexList[3].p = m_VertexList[0].p + TVector3(width * 2, -height * 2, 0);
