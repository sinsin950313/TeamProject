...
void ArcBall::SetTranslationRadius(FLOAT fRadiusTranslation)
{
...
TVector3 ArcBall::ScreenToVector(float fScreenPtX, float fScreenPtY)
{
...
//--------------------------------------------------------------------------------------
TQuaternion ArcBall::QuatFromBallPoints(const TVector3& vFrom, const TVector3& vTo)
{
