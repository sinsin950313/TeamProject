...
void CArcBall::SetTranslationRadius(FLOAT fRadiusTranslation)
{
    m_fRadiusTranslation = fRadiusTranslation;
}
void CArcBall::SetWindow(INT nWidth, INT nHeight, FLOAT fRadius)
{
    m_nWidth = nWidth;
    m_nHeight = nHeight;
    m_fRadius = fRadius;
...
void CArcBall::SetOffset(INT nX, INT nY)
{
    m_Offset.x = nX;
    m_Offset.y = nY;
}
...
TVector3 CArcBall::ScreenToVector(float fScreenPtX, float fScreenPtY)
{
...
//--------------------------------------------------------------------------------------
TQuaternion CArcBall::QuatFromBallPoints(const TVector3& vFrom, const TVector3& vTo)
{
...
// Desc:
//--------------------------------------------------------------------------------------
LRESULT CArcBall::HandleMessages(HWND hWnd, UINT uMsg, WPARAM wParam, LPARAM lParam)
{
